...
#resnet = torch.load('weights/resnet18_Train54.717Test45.319.pkl')
#resnet = torch.load('weights/resnet18_Train64.804Test57.223.pkl')
#resnet = torch.load('weights/resnet18_Train100.0Test85.711.pkl')
resnet = torch.load('weights/resnet18_Train100.0Test85.711.pkl')
resnet = resnet.cuda()
...
for i, (samples, labels) in enumerate(test_data_loader):
    ...
    if i == 0:
        ...
        # moved tempC and tempR to cpu and converted to numpy 
        tempC = tempC.detach().cpu().numpy()
        tempR = tempR.detach().cpu().numpy()
...
sio.savemat('results/train100-test_85.mat', {'human_prediction2': human_prediction})
